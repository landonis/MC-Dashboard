...
def disable_service():
    ...
    try:
        run_command("/usr/bin/systemctl daemon-reload")
        result = run_command("/usr/bin/systemctl disable minecraft.service")
...
def start_server():
    ...
    try:
        ...
        result = run_command("/usr/bin/systemctl start minecraft.service")
...
def stop_server():
    ...
    try:
        result = run_command("/usr/bin/systemctl stop minecraft.service")
...
def restart_server():
    ...
    try:
        result = run_command("/usr/bin/systemctl restart minecraft.service")
...
def build_server():
    ...
    try:
        ...
        run_command("/usr/bin/systemctl stop minecraft.service")
