...
def get_server_status():
    ...
    try:
        ...
        status_result = run_command("/bin/systemctl is-active minecraft.service")
        is_running = status_result['success'] and status_result['stdout'].strip() == 'active'
        
        # Get detailed status
        detail_result = run_command("/bin/systemctl status minecraft.service --no-pager -l")
...
def enable_service():
    ...
    try:
        ...
        result = run_command("/bin/systemctl enable minecraft.service")
...
def disable_service():
    ...
    try:
        run_command("/bin/systemctl daemon-reload")
        result = run_command("/bin/systemctl disable minecraft.service")
